...
import { Sliders, Settings, Play, RefreshCw, FileText, FileAudio, FileVideo, Sparkles, HelpCircle, AlertCircle } from "lucide-react";
        ...
        <div className="space-y-2 mb-4">
          ...
          <div className="grid grid-cols-3 gap-1.5 p-1 bg-[#F5F7FB] rounded-xl border border-[#E4E8F0]">
            ...
            <button
              disabled
              title="Kommt bald"
              className="flex items-center justify-center gap-1.5 py-1.5 rounded-lg text-xs font-semibold text-gray-400 cursor-not-allowed bg-transparent"
            >
              <FileAudio className="w-3.5 h-3.5 opacity-60" />
              <span className="opacity-0 sm:opacity-100">Audio </span>
              <span className="text-[8px] bg-gray-200 px-1 py-0.2 rounded-sm text-gray-500 scale-90">Bald</span>
            </button>
            <button
              disabled
              title="Kommt bald"
              className="flex items-center justify-center gap-1.5 py-1.5 rounded-lg text-xs font-semibold text-gray-400 cursor-not-allowed bg-transparent"
            >
              <FileVideo className="w-3.5 h-3.5 opacity-60" />
              <span className="opacity-0 sm:opacity-100">Video </span>
              <span className="text-[8px] bg-gray-200 px-1 py-0.2 rounded-sm text-gray-500 scale-90">Bald</span>
            </button>
          </div>
        </div>
        ...
        <div className="space-y-2.5 mb-4">
          ...
          <div className="relative">
            <textarea
              ...
              placeholder="Fügen Sie hier den Chat-Verlauf, E-Mail-Inhalt oder ein Transkript ein (z.B. 'A: Tun Sie das für mich ...')."
